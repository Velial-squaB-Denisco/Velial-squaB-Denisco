...
<div align="center">
  <div style="width: 150px; height: 150px; background: #58a6ff; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 20px #58a6ff;">
    <span style="font-size: 48px; color: white; font-weight: bold;">DC</span>
  </div>
  <br>
